...
// NOTE: askDriverAssistant (the Gemini call) has moved to /api/assistant.js.
// That endpoint runs server-side on Vercel, so the Gemini API key never
// reaches the browser. This file stays client-safe: no API keys, no
// GoogleGenAI import, nothing that shouldn't be visible in the public bundle.