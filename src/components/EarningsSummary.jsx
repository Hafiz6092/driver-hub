...
const EarningSummary = ({shifts}) => {
    ...
    const formattedGross = totals.gross.toLocalString();
    const formattedExpenses = totals.expenses.toLocalString();
    formattedNet = totals.netProfit.toLocalString();
